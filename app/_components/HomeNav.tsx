...
const HomeNav = () => {
  return (
    <NavigationMenuItem>
      ...
      <NavigationMenuContent>
        <div className="w-[500px] h-[250px] p-4 dark:bg-[url('/pattern-2.png')] bg-[url('/pattern-1.png')] bg-no-repeat bg-cover flex justify-center items-center rounded-sm relative z-10 animate-fade-in">
