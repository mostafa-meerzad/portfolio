...
const AboutMe = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[0.7fr_1fr] items-center gap-8 mt-10">
      ...
      />
      <p className=" text-lg lg:text-xl lg:leading-loose text-center max-sm:mx-auto md:text-start col-start-1 col-end-3 md:col-start-2  place-self-center px-3 border rounded-2xl py-3 md:p-5 background h-full  content-center ">
